...
void build_data(bLisp_TokenClass *_result, wchar_t *input_data[num_tests])
{
	...
	_result[15]= bLisp_ArrayToken;   input_data[15]= L"array";
	_result[17]= bLisp_SharpToken;   input_data[17]= L"#";
	_result[18]= bLisp_SharpToken;   input_data[18]= L"#";
	_result[19]= bLisp_SharpToken;   input_data[19]= L"#";
	...
	_result[24]= bLisp_SharpToken;   input_data[24]= L"#";
	_result[25]= bLisp_SharpToken;   input_data[25]= L"#";
